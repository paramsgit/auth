...
import Switcher from './modeSwitch/switch'
...
<nav className="bg-white dark:bg-[#121212] fixed w-full z-50 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
  <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
  <a href="" className="flex items-center  md:px-2 md:py-1 rounded-lg rtl:space-x-reverse">
      <img src={'/walletLogo.png'} className="h-8 " alt="Flowbite Logo" />
  ...
  <Switcher/>
      ...
      <button onClick={()=>signOut()} type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg sm:rounded-2xl md:rounded-lg text-xs md:text-sm px-3 py-2 md:px-4 md:py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        
       <span className='hidden sm:block'> Sign Out</span>
       <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-box-arrow-right sm:hidden" viewBox="0 0 16 16">
